...
const mockFlashcards = [
  { id: 1, word: "Desarrollo", translation: "Development", example: "El desarrollo de software es fascinante." },
  { id: 2, word: "Sobremesa", translation: "Table talk", example: "Tuvimos una larga sobremesa después de cenar." },
  { id: 3, word: "Estrenar", translation: "To wear/use for the first time", example: "Voy a estrenar mis zapatos nuevos." },
  { id: 4, word: "Madrugar", translation: "To get up early", example: "Mañana tengo que madrugar mucho." },
  { id: 5, word: "Empalagar", translation: "To be too sweet / cloy", example: "Este pastel me empalaga." }
];
          ...
          >
            <div className={`w-full h-full transition-transform duration-500 transform-style-3d ${isFlipped ? 'rotate-y-180' : ''}`}>
              ...
              <div className="absolute inset-0 backface-hidden bg-white rounded-[2rem] shadow-xl border border-slate-200 flex flex-col items-center justify-center p-8 group-hover:border-es-red-200 transition-colors">
                ...
                <h2 className="text-5xl font-black text-slate-800 mb-4 capitalize text-center">{card.word}</h2>
              ...
              <div className="absolute inset-0 backface-hidden bg-gradient-to-br from-es-red-600 to-es-yellow-500 rounded-[2rem] shadow-xl border-2 border-transparent flex flex-col items-center justify-center p-8 text-center rotate-y-180 text-white">
                ...
                <h2 className="text-4xl font-black mb-6 drop-shadow-sm">{card.translation}</h2>
