  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-4 transition-colors">
      ...
      <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-800 max-w-md w-full transition-colors">
        <h1 className="text-3xl font-black text-slate-800 dark:text-white mb-6 text-center">Log In</h1>
        ...
        <p className="mt-6 text-center text-slate-500 dark:text-slate-400">
          Don't have an account? <Link href="/register" className="text-es-red-600 dark:text-es-red-500 font-bold hover:underline">Register</Link>
        </p>
      </div>
    </div>
  );
