        ...
        {!isSignedIn && (
          <div className="max-w-4xl space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 my-24 flex flex-col items-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-8">
              <Link href="/register">
                <button className="bg-gradient-to-r from-es-red-600 to-es-red-700 text-white px-10 py-5 rounded-full font-bold text-xl hover:scale-105 hover:shadow-2xl hover:shadow-es-red-500/40 transition-all flex items-center gap-3">
                  Activate Account <ArrowRight className="w-6 h-6 suppressHydrationWarning" />
                </button>
              </Link>
            </div>
          </div>
